			...
			!(function (n) {
				...
				a[r] = e.map(function (n) {
					var e,
						t = {};
					for (e in n)
						w.key(e) ? e == r && (t.value = n[e]) : (t[e] = n[e]);
					return t;
				});
			})(n);
		return a;
				...
				r.push({
					...
					tweens: (function (n, t) {
						var e,
							r = g(t),
							a =
								(/^spring/.test(r.easing) &&
									(r.duration = c(r.easing)),
								w.arr(n) &&
									(2 === (e = n.length) && !w.obj(n[0])
										? (n = { value: n })
										: w.fnc(t.duration) ||
										  (r.duration = t.duration / e)),
								w.arr(n) ? n : [n]);
						return a
							.map(function (n, e) {
				...
				for (
					var a = t[n],
						...
						i =
							...
							C(e - c.start - c.delay, 0, c.duration) /
								c.duration),
	...
	return (
		...
		(L.stagger = function (n, e) {
			...
			return function (n, e, t) {
				...
				return (
					b +
					(g ? (v - m) / x : m) * (Math.round(100 * M[e]) / 100) +
					y
				);
			};
		}),
